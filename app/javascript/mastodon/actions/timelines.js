...
export const fetchAccountTimeline          = (accountId, { withReplies, withoutReblogs, tagged } = {}) => expandTimeline(`account:${accountId}${withReplies ? ':with_replies' : ''}${withoutReblogs ? ':without_reblogs' : ''}${tagged ? `:${tagged}` : ''}`, `/api/v1/accounts/${accountId}/statuses`, { fetch: true, exclude_replies: !withReplies, exclude_reblogs: withoutReblogs, tagged, limit: 5 });
